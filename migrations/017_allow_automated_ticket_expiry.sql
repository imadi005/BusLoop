-- Allow automated expiry of stale active tickets while preserving checker safety rules.
...
BEGIN
  ...
  IF OLD.status = 'active'
    ...
    AND OLD.booked_at < NOW() - INTERVAL '2 hours'
...
SELECT public.expire_stale_active_tickets();
